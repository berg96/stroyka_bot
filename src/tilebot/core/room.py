...
# Разумная высота помещения. Нужна не для придирок, а против перепутанных единиц:
# Саня говорит «высота 27», имея в виду 2,7 м, и по общему правилу «меньше 20 —
# метры» это стало бы комнатой в 27 метров. Молча считать такую нельзя.
MIN_HEIGHT_M = 1.0
MAX_HEIGHT_M = 6.0
